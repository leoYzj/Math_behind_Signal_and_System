...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Figure_2}\label{fig:2.2}
    \caption{周期矩形脉冲信号及其频谱}
\end{figure}

如图\ref{fig:2.2}，可以看到，这个频谱与取样函数$Sa(\omega)$非常相似（为了体现这一点，绘制频谱时将
...
脉冲信号，它的基波角频率应为图\ref{fig:2.2}中两相邻竖直线间的间隔，即\textbf{谱线间隔}，可见其频率极
...
入信号发生时移，输出信号也发生相同的时移，即$\forall \tau\in\mathbb{R},H[e(t-\tau)]=r(t-\tau)$.
